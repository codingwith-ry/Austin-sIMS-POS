...
('395635613', 'Employee', 'Patrick Star', 'patrickstar@gmail.com', '654321', 9257717724, 'Active'),
('598353747', 'Administrator', 'John Doe', 'admin@gmail.com', '123456', 9257717724, 'Active'),
('622629934', 'Employee', 'Michael Owen Trinidad', 'owen@gmail.com', 'chocol', 9338554006, 'Active'),
('758312388', 'Inventory Staff Management', 'Stephen Lance Hao', 'stephenlance.hao@gmail.com', 'TesT12', 9943182983, 'Active'),
('987654321', 'Inventory Staff Management', 'Spongebob ', 'dominicxandy.adino.cics@ust.edu.ph', '123456', 9257717724, 'Active');
...
--
-- Table structure for table `tbl_inventory_changes`
--
...
CREATE TABLE `tbl_inventory_changes` (
  ...
  `Change_Type` enum('decrease','increase') NOT NULL,
  `Change_Date` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_inventory_changes`
--

INSERT INTO `tbl_inventory_changes` (`Change_ID`, `Record_ID`, `Change_Quantity`, `Change_Type`, `Change_Date`) VALUES
(9, 746031, 20, 'decrease', '2025-04-16 14:06:54'),
(10, 784516, 12, 'decrease', '2025-04-16 14:07:08'),
(11, 215615, 10, 'decrease', '2025-04-17 03:41:24'),
(12, 438352, 8, 'decrease', '2025-04-17 12:08:29');
...
(7, 'Nescafe Coffee Powder', 'itemImages/nescafe.webp', 7, 5),
(8, 'Condensada', 'itemImages/alaska condensada.webp', 7, 10),
(9, 'Garlic', 'itemImages/garlic.webp', 8, 5);
...
(215615, 7, 1500, 10, 500, '2025-04-21', '2025-04-15', 'Nestle', '987654321'),
(353441, 9, 60, 20, 50, '2026-07-18', '2025-07-18', 'N/A', '758312388'),
(412297, 9, 60, 25, 600, '2026-05-21', '2025-05-21', 'N/A', '987654321'),
(438352, 5, 1200, 10, 150, '2026-05-21', '2025-05-21', 'Nestle', '395635613'),
(514828, 6, 1500, 10, 150, '2026-05-21', '2024-05-21', 'Coca-cola', '506749182'),
(551975, 8, 160, 10, 350, '2025-04-17', '2024-01-21', 'Alaska', '123456789'),
(746031, 3, 10, 20, 50, '2026-10-20', '2025-04-15', 'N/A', '123456789'),
(784516, 4, 355, 15, 500, '2026-04-17', '2025-04-16', 'Bounty Fresh', '598353747'),
(888887, 3, 10, 25, 500, '2026-04-14', '2025-04-14', 'N/A', '123456789');
...
ALTER TABLE `tbl_addons`
  ...
  ADD KEY `FK_tbl_addons_tbl_menuclass` (`menuID`);
...
--
-- Indexes for table `tbl_inventory_changes`
--
ALTER TABLE `tbl_inventory_changes`
  ADD PRIMARY KEY (`Change_ID`) USING BTREE,
  ADD KEY `Record_ID` (`Record_ID`) USING BTREE;
...
ALTER TABLE `tbl_item`
  ...
  ADD KEY `FK_tbl_item_tbl_unitofmeasurments` (`Unit_ID`) USING BTREE;
...
ALTER TABLE `tbl_menutoaddons`
  ...
  ADD KEY `FK_tbl_menutoaddons_tbl_menu` (`productID`),
  ADD KEY `FK_tbl_menutoaddons_tbl_addons` (`addonID`);

--
-- Indexes for table `tbl_orderaddons`
--
ALTER TABLE `tbl_orderaddons`
  ADD PRIMARY KEY (`orderAddonID`),
  ADD KEY `FK_tbl_orderaddons_tbl_addons` (`addonID`),
  ADD KEY `FK_tbl_orderaddons_tbl_orderitems` (`orderItemID`);
...
ALTER TABLE `tbl_orderitems`
  ...
  ADD KEY `FK_tbl_orderitems_tbl_orders` (`orderNumber`),
  ADD KEY `FK_tbl_orderitems_tbl_menu` (`productID`),
  ADD KEY `FK_tbl_orderitems_tbl_variations` (`variationID`),
  ADD KEY `FK_tbl_orderitems_tbl_orders_2` (`salesOrderNumber`);
...
ALTER TABLE `tbl_orders`
  ...
  ADD KEY `FK_tbl_orders_employees` (`employeeID`),
...
ALTER TABLE `tbl_variations`
  ...
  ADD KEY `FK_tbl_variations_tbl_menu` (`productID`);
...
--
-- AUTO_INCREMENT for table `tbl_inventory_changes`
--
ALTER TABLE `tbl_inventory_changes`
  MODIFY `Change_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_menu`
  MODIFY `productID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=200;
...
--
ALTER TABLE `tbl_menutoaddons`
  MODIFY `menuAddonID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=231;

--
-- AUTO_INCREMENT for table `tbl_orderaddons`
--
ALTER TABLE `tbl_orderaddons`
  MODIFY `orderAddonID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;

--
-- AUTO_INCREMENT for table `tbl_orderitems`
--
ALTER TABLE `tbl_orderitems`
  MODIFY `orderItemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `tbl_variations`
  MODIFY `variationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `tbl_addons`
  ADD CONSTRAINT `FK_tbl_addons_tbl_menuclass` FOREIGN KEY (`menuID`) REFERENCES `tbl_menuclass` (`menuID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_inventory_changes`
--
ALTER TABLE `tbl_inventory_changes`
  ADD CONSTRAINT `tbl_inventory_changes_ibfk_1` FOREIGN KEY (`Record_ID`) REFERENCES `tbl_record` (`Record_ID`);

--
-- Constraints for table `tbl_menutoaddons`
--
ALTER TABLE `tbl_menutoaddons`
  ADD CONSTRAINT `FK_tbl_menutoaddons_tbl_addons` FOREIGN KEY (`addonID`) REFERENCES `tbl_addons` (`addonID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_tbl_menutoaddons_tbl_menu` FOREIGN KEY (`productID`) REFERENCES `tbl_menu` (`productID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_orderaddons`
--
ALTER TABLE `tbl_orderaddons`
  ADD CONSTRAINT `FK_tbl_orderaddons_tbl_addons` FOREIGN KEY (`addonID`) REFERENCES `tbl_addons` (`addonID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_tbl_orderaddons_tbl_orderitems` FOREIGN KEY (`orderItemID`) REFERENCES `tbl_orderitems` (`orderItemID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_orderitems`
--
ALTER TABLE `tbl_orderitems`
  ADD CONSTRAINT `FK_tbl_orderitems_tbl_menu` FOREIGN KEY (`productID`) REFERENCES `tbl_menu` (`productID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_tbl_orderitems_tbl_orders` FOREIGN KEY (`orderNumber`) REFERENCES `tbl_orders` (`orderNumber`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_tbl_orderitems_tbl_orders_2` FOREIGN KEY (`salesOrderNumber`) REFERENCES `tbl_orders` (`salesOrderNumber`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_tbl_orderitems_tbl_variations` FOREIGN KEY (`variationID`) REFERENCES `tbl_variations` (`variationID`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `tbl_orders`
--
ALTER TABLE `tbl_orders`
  ADD CONSTRAINT `FK_tbl_orders_employees` FOREIGN KEY (`employeeID`) REFERENCES `employees` (`Employee_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `tbl_variations`
--
ALTER TABLE `tbl_variations`
  ADD CONSTRAINT `FK_tbl_variations_tbl_menu` FOREIGN KEY (`productID`) REFERENCES `tbl_menu` (`productID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
