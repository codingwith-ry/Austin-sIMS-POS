...
-- Dumping data for table austingastropub.tbl_orderaddons: ~10 rows (approximately)
...
-- Dumping data for table austingastropub.tbl_orderitems: ~15 rows (approximately)
INSERT INTO `tbl_orderitems` (`orderItemID`, `orderNumber`, `salesOrderNumber`, `productID`, `variationID`, `productQuantity`, `productTotal`) VALUES
	...
	(67, 1003, 10003, 180, NULL, 1, 380.00),
	...
	(80, 1001, 10007, 38, 50, 2, 530.00),
	(81, 1001, 10007, 79, NULL, 3, 1050.00),
...
INSERT INTO `tbl_orders` (`orderID`, `orderNumber`, `orderDate`, `orderTime`, `orderClass`, `orderStatus`, `salesOrderNumber`, `employeeID`, `customerName`, `totalAmount`, `amountPaid`, `paymentMode`, `additionalNotes`) VALUES
	(51, 1001, '2025-04-15', '16:24:08', 'Dine In', 'PICKUP', 10001, '123456789', 'Rai', 330.00, 400.00, 'Cash', 'ertertert'),
	(52, 1002, '2025-04-15', '16:25:51', 'Take Out', 'PICKUP', 10002, '123456789', 'Rai', 230.00, 300.00, 'Cash', 'dfgdfgdfg'),
	(53, 1003, '2025-04-15', '16:58:25', 'Dine In', 'IN PROCESS', 10003, '123456789', 'Jy', 2745.00, 3000.00, 'Cash', 'ertertert'),
	(54, 1004, '2025-04-15', '18:29:06', 'Dine In', 'IN PROCESS', 10004, '123456789', 'Rai', 390.00, 400.00, 'Cash', 'fgdfgdfg'),
	(55, 1005, '2025-04-15', '18:48:34', 'Take Out', 'IN PROCESS', 10005, '123456789', 'Rai', 100.00, 100.00, 'Cash', ''),
	(56, 1006, '2025-04-15', '19:16:56', 'Dine In', 'IN PROCESS', 10006, '123456789', 'rrrrrtery', 4000.00, 4000.00, 'Cash', 'rtertrt'),
	(63, 1001, '2025-04-16', '16:14:41', 'Take Out', 'IN PROCESS', 10007, '123456789', 'Ferrari', 1580.00, 2000.00, 'Cash', 'None'),
	(64, 1002, '2025-04-16', '16:18:52', 'Dine In', 'IN PROCESS', 10008, '123456789', 'Ryan', 1240.00, 2000.00, 'Cash', 'None');
